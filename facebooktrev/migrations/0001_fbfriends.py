...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('facebooktrev_facebookuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uid', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['whatever.CustomUser'], null=True, blank=True)),
        ))
        db.send_create_signal('facebooktrev', ['FacebookUser'])


    def backwards(self, orm):
        
        # Deleting model 'FacebookUser'
        db.delete_table('facebooktrev_facebookuser')
