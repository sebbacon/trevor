...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('whatever_division', (
            ('id', orm['whatever.division:id']),
            ('name', orm['whatever.division:name']),
        ))
        db.send_create_signal('whatever', ['Division'])
        
        # Adding field 'CustomUser.supported_team'
        db.add_column('whatever_customuser', 'supported_team', orm['whatever.customuser:supported_team'])
        
        # Adding field 'Team.division'
        db.add_column('whatever_team', 'division', orm['whatever.team:division'])
        
        # Deleting field 'CustomUser.postcode'
        db.delete_column('whatever_customuser', 'postcode')
    ...
    def backwards(self, orm):
        ...
        db.delete_table('whatever_division')
        
        # Deleting field 'CustomUser.supported_team'
        db.delete_column('whatever_customuser', 'supported_team_id')
        
        # Deleting field 'Team.division'
        db.delete_column('whatever_team', 'division_id')
        
        # Adding field 'CustomUser.postcode'
        db.add_column('whatever_customuser', 'postcode', orm['whatever.customuser:postcode'])
