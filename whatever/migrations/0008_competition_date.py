...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.competition_date'
        now = datetime.datetime.now()
        db.add_column('whatever_competition',
                      'competition_date',
                      models.DateTimeField(default=now),
                                           keep_default=False)
        
        # Changing field 'Prediction.edited_date'
        # (to signature: django.db.models.fields.DateTimeField(auto_now_add=True, blank=True))
        db.alter_column('whatever_prediction',
                        'edited_date', orm['whatever.prediction:edited_date'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Competition.competition_date'
        db.delete_column('whatever_competition', 'competition_date')
        
        # Changing field 'Prediction.edited_date'
        # (to signature: django.db.models.fields.DateTimeField(auto_now_add=True, null=True, blank=True))
        db.alter_column('whatever_prediction', 'edited_date', orm['whatever.prediction:edited_date'])
