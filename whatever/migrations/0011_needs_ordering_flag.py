...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Prediction.needs_ordering'
        db.add_column('whatever_prediction', 'needs_ordering', orm['whatever.prediction:needs_ordering'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Prediction.needs_ordering'
        db.delete_column('whatever_prediction', 'needs_ordering')
