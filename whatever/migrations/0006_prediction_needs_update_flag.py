...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Prediction.needs_update'
        db.add_column('whatever_prediction', 'needs_update', orm['whatever.prediction:needs_update'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Prediction.needs_update'
        db.delete_column('whatever_prediction', 'needs_update')
