...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.teaser'
        db.add_column('whatever_competition', 'teaser', orm['whatever.competition:teaser'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Competition.teaser'
        db.delete_column('whatever_competition', 'teaser')
