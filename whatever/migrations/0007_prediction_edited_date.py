...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Prediction.edited_date'
        foreign_key = orm['whatever.prediction:edited_date']
        # Adding field 'Prediction.competition'
        db.add_column('whatever_prediction', 'edited_date', foreign_key)
        for item in orm.Prediction.objects.all():
            if item.created_date:
                item.edited_date = item.created_date
                item.save()        
    
    def backwards(self, orm):
        
        # Deleting field 'Prediction.edited_date'
        db.delete_column('whatever_prediction', 'edited_date')
    ...
    models = {
        ...
        'whatever.prediction': {
            ...
            'edited_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True', 'null':'True'}),
