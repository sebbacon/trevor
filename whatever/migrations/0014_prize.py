...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.prize'
        db.add_column('whatever_competition', 'prize', orm['whatever.competition:prize'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Competition.prize'
        db.delete_column('whatever_competition', 'prize')
