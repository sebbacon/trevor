...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomUser.login_count'
        db.add_column('whatever_customuser', 'login_count', orm['whatever.customuser:login_count'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'CustomUser.login_count'
        db.delete_column('whatever_customuser', 'login_count')
