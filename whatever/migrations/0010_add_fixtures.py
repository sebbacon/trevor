...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('whatever_fixture', (
            ('id', orm['whatever.fixture:id']),
            ('date', orm['whatever.fixture:date']),
            ('home', orm['whatever.fixture:home']),
            ('away', orm['whatever.fixture:away']),
        ))
        db.send_create_signal('whatever', ['Fixture'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('whatever_fixture')
